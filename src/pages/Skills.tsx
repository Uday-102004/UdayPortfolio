...
const Skills = () => {
  ...
  const renderSkillSection = (title: string, skills: any[], icon: string) => (
    <div className="bg-slate-800/50 backdrop-blur-md rounded-xl p-6 border border-slate-700/50 animate-fade-in">
      ...
      <div className="relative z-10 pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-slate-800/50 backdrop-blur-md rounded-xl p-6 border border-slate-700/50 animate-fade-in">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-semibold text-white">Skills Distribution</h3>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in">
            <div className="text-center p-6 bg-slate-800/30 rounded-lg border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300">
              <div className="text-3xl mb-3">🤖</div>
              <h4 className="font-semibold text-white mb-2">Drone Technology</h4>
              <p className="text-gray-400 text-sm">Autonomous flight systems</p>
            </div>
            
            <div className="text-center p-6 bg-slate-800/30 rounded-lg border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300">
              <div className="text-3xl mb-3">🔧</div>
              <h4 className="font-semibold text-white mb-2">Robotics</h4>
              <p className="text-gray-400 text-sm">Embedded systems & IoT</p>
            </div>
            
            <div className="text-center p-6 bg-slate-800/30 rounded-lg border border-slate-700/50 hover:border-green-500/50 transition-all duration-300">
              <div className="text-3xl mb-3">📈</div>
              <h4 className="font-semibold text-white mb-2">Data Analytics</h4>
              <p className="text-gray-400 text-sm">Statistical analysis & ML</p>
            </div>
            
            <div className="text-center p-6 bg-slate-800/30 rounded-lg border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300">
              <div className="text-3xl mb-3">☁️</div>
              <h4 className="font-semibold text-white mb-2">Cloud Computing</h4>
              <p className="text-gray-400 text-sm">AWS & Azure basics</p>
            </div>
          </div>
        </div>
      </div>
